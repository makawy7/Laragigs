<x-layout>
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="{{ route('updateListing', $listing->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="mb-6">
                <label for="company" class="inline-block text-lg mb-2">Company Name</label>
                <input type="text" value="{{ old('company') ?? $listing->company }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ old('title') ?? $listing->title }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ old('location') ?? $listing->location }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ old('email') ?? $listing->email }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ old('website') ?? $listing->website }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" value="{{ old('tags') ?? $listing->tags }}"
